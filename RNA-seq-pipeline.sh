...
Bovine_genome="${folder}/Bovine_genome"
#######################################################3
cd ${your_folder}
srr_id=`cat download-SRR-files.txt| head -n $SLURM_ARRAY_TASK_ID|tail -n 1`
srs_name=`cat SRS_sample_name.txt| head -n $SLURM_ARRAY_TASK_ID|tail -n 1`
############################################################
